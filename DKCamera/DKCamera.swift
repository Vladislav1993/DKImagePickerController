...
open class DKCamera: UIViewController {
    ...
    open func setupUI() {
        ...
        let cancelButton: UIButton = {
            let cancelButton = UIButton()
            cancelButton.addTarget(self, action: #selector(DKCamera.dismissScreen), for: .touchUpInside)
    ...
    open func takePicture() {
        ...
        if let stillImageOutput = self.stillImageOutput {
            ...
            DispatchQueue.global().async(execute: {
                ...
                stillImageOutput.captureStillImageAsynchronously(from: connection, completionHandler: { (imageDataSampleBuffer, error) -> Void in
