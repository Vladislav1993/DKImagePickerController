...
public class DKImagePickerController : UINavigationController {
	...
	public var assetType: DKImagePickerControllerAssetType = .AllPhotos {
		didSet {
    ...
    public var sourceType: DKImagePickerControllerSourceType = .Photo {
    ...
    lazy var bottonCount: UIButton = {
        return self.createBottonCount()
    }()
