...
internal class DKAssetGroupDetailVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, DKGroupDataManagerObserver {
    ...
    class DKAssetCell: UICollectionViewCell {
        ...
        class DKImageCheckView: UIView {
            ...
            internal lazy var checkImageView: UIImageView = {
                ...
                let imageView = UIImageView(image: UIImage(named: "check_cover"))
                return imageView
            }()
	...
	*/
    ...
    {
         self.navigationItem.title = "Выбор фотографии"
	}
    ...
    let spaceItem = CGFloat(4)
    func collectionView(collectionView: UICollectionView,
                        layout collectionViewLayout: UICollectionViewLayout,
                               sizeForItemAtIndexPath indexPath: NSIndexPath) -> CGSize {
        let countItemRow = CGFloat(3)
        let width = (CGRectGetWidth(UIScreen.mainScreen().bounds) - spaceItem * (countItemRow + 1))/countItemRow
    ...
    func collectionView(collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAtIndex section: Int) -> UIEdgeInsets {
        ...
        return UIEdgeInsetsMake(0, spaceItem, 0, spaceItem)
    }
}
